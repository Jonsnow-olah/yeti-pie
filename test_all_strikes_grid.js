...
async function main() {
  const strikes = [64000, 64500, 65000, 65500, 66000, 66500, 67000, 67500, 68000];
  console.log('Testing strikes to find boundaries:');
  for (const strike of strikes) {
    const res = await queryTradeAmounts(strike, true);
